  ...
  if (loading) {
    return (
      <>
        ...
        <PageHeader title="" backRoute="/id-verification" />
    ...
    return (
      <>
        ...
        <View style={styles.loadingContainer}>
          ...
          <TouchableOpacity
            style={styles.button}
            onPress={() => router.replace('/register-email')}
          >
      ...
      <View style={styles.container}>
        ...
        <ScrollView style={styles.scrollView} contentContainerStyle={styles.scrollContent}>
          ...
          <View style={styles.section}>
            ...
            <InfoRow
              label="Name"
              value={`${data.firstName} ${data.middleName} ${data.lastName}`.trim()}
            />
...
const styles = StyleSheet.create({
  ...
  errorTitle: { marginTop: 20, fontSize: 20, fontWeight: 'bold', color: '#333' },
  header: {
    flexDirection: 'row',
    alignItems: 'center',
...
title: {
  ...
  sectionTitle: { fontSize: 18, fontWeight: 'bold', color: '#008080', marginBottom: 15 },
  infoRow: {
    flexDirection: 'row',
    paddingVertical: 10,
    borderBottomWidth: 1,
  ...
  infoLabel: { fontSize: 14, color: '#666', width: 120, fontWeight: '500' },
  infoValue: { fontSize: 14, color: '#333', flex: 1, fontWeight: '600' },
  idPhotoContainer: { marginTop: 15, alignItems: 'center' },
  idPhoto: { width: '100%', height: 200, borderRadius: 10, borderWidth: 1, borderColor: '#ddd' },
  footer: {
    padding: 20,
    borderTopWidth: 1,
