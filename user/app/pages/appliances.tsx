      ...
      >
        <SafeAreaView style={homeStyles.safeArea}>
          ...
          <View style={homeStyles.border}>
            ...
            <Text style={homeStyles.borderDesc}>
              Refrigerator not cooling, uneven temperature, water leaks,
              excessive frost build-up, compressor not running or overworking,
              control panel issues, frequent breaker trips, unusual noises
              (clicking, buzzing, humming), dirty condenser coils, worn-out door
              gaskets, foul odors, faulty relay or capacitor, need for cleaning,
              inspection, or circuit board check.
            </Text>
            <View style={{ flexDirection: "row", justifyContent: "flex-end" }}>
              <TouchableOpacity onPress={() => router.push("../serviceprovider")}>
                <Text
