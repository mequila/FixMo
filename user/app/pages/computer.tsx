        ...
        <SafeAreaView style={homeStyles.safeArea}>
          <View style={homeStyles.border}>
            ...
            <Text style={homeStyles.borderDesc}>
              Computer not powering on, frequent system crashes, slow
              performance, overheating issues, blue screen errors, hardware
              malfunctions, faulty power supply, unresponsive keyboard or mouse,
              corrupted operating system, need for diagnostic checks.
            </Text>
          ...
          <View style={homeStyles.border}>
            ...
            <Text style={homeStyles.borderDesc}>
              ...
              files, creating system restore points, securing sensitive
              documents, scheduled automatic backups, migration to new device.
            </Text>
            <View style={{ flexDirection: "row", justifyContent: "flex-end" }}>
              <TouchableOpacity onPress={() => router.push("/serviceprovider")}>
                <Text
