      ...
      >
        ...
        <View style={homeStyles.border}>
          ...
          <Text style={homeStyles.borderDesc}>
            ...
            overheating issues, blue screen errors, hardware malfunctions,
            faulty power supply, unresponsive keyboard or mouse, corrupted
            operating system, need for diagnostic checks.
          </Text>
